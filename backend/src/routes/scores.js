...
const SCORING_MODELS = {
  ...
  ecosystem_signal: [
    { key: 'topic_relevance', name: 'Topic Relevance to Business', max: 20 },
    { key: 'geographic_relevance', name: 'Geographic Relevance', max: 15 },
    { key: 'market_impact', name: 'Market Impact Potential', max: 15 },
    { key: 'funding_implication', name: 'Funding Implication Strength', max: 15 },
    { key: 'contract_implication', name: 'Contract Implication Strength', max: 15 },
    { key: 'urgency', name: 'Urgency & Timeliness', max: 10 },
    { key: 'marketing_activation', name: 'Marketing Activation Potential', max: 5 },
    { key: 'evidence', name: 'Source Credibility', max: 5 },
  ],
  county_state: [
    { key: 'ag_activity', name: 'Agricultural Activity Level', max: 20 },
    { key: 'budget_capacity', name: 'Budget & Spending Capacity', max: 15 },
    { key: 'program_alignment', name: 'Program Alignment', max: 15 },
    { key: 'decision_access', name: 'Decision-Maker Accessibility', max: 15 },
    { key: 'procurement_history', name: 'Procurement History', max: 15 },
    { key: 'geographic_fit', name: 'Geographic Service Fit', max: 10 },
    { key: 'relationship_base', name: 'Existing Relationship Base', max: 5 },
    { key: 'evidence', name: 'Evidence Quality', max: 5 },
  ],
  funding: [
    { key: 'mission_alignment', name: 'Mission & Eligibility Alignment', max: 20 },
    { key: 'award_range', name: 'Award Range Fit', max: 15 },
    { key: 'deadline_feasibility', name: 'Application Deadline Feasibility', max: 10 },
    { key: 'match_requirements', name: 'Match Requirement Feasibility', max: 10 },
    { key: 'past_awards', name: 'Past Award History to Similar Orgs', max: 10 },
    { key: 'geographic_priority', name: 'Geographic Priority Alignment', max: 10 },
    { key: 'tech_readiness', name: 'Technology Readiness Level', max: 10 },
    { key: 'relationship', name: 'Program Officer Relationship', max: 10 },
    { key: 'evidence', name: 'Evidence Quality', max: 5 },
  ],
  contract: [
    { key: 'requirement_fit', name: 'Requirement Fit', max: 20 },
    { key: 'competition_level', name: 'Competition Level', max: 15 },
    { key: 'past_performance', name: 'Past Performance Alignment', max: 15 },
    { key: 'set_aside', name: 'Set-Aside / Eligibility', max: 10 },
    { key: 'vehicle_access', name: 'Contract Vehicle Access', max: 10 },
    { key: 'timeline_feasibility', name: 'Timeline Feasibility', max: 10 },
    { key: 'price_competitiveness', name: 'Price Competitiveness', max: 10 },
    { key: 'incumbent_risk', name: 'Incumbent Risk Assessment', max: 5 },
    { key: 'evidence', name: 'Evidence Quality', max: 5 },
  ],
}
