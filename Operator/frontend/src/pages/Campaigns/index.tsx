    ...
    <div className="space-y-5">
        ...
        <div className="col-span-2">
          {!selected ? (
            <div className="op-card p-8 text-center space-y-3">
              ...
              <p className="text-xs text-slate-700">Types: Book Launch · Investor Round · Brand Awareness · Farmer Outreach · Gov/Policy · Media Push · Speaking</p>
            </div>
          ) : (
      ...
      <Modal open={showAdd || !!editing} onClose={() => { setShowAdd(false); setEditing(null); setForm({ ...EMPTY }) }} title={editing ? 'Edit Campaign' : 'New Campaign'} size="lg">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="col-span-2"><label className="op-label">Target Audience</label><input className="op-input" value={form.target_audience} onChange={f('target_audience')} placeholder="e.g. Ranchers in TX, OK, NM · Ag-tech investors" /></div>
